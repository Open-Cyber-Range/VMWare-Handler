...
type ChildGeneralSecurityProfileBindingMap struct {
	...
	GeneralSecurityProfileBindingMap *GeneralSecurityProfileBindingMap `json:"GeneralSecurityProfileBindingMap"`
}
