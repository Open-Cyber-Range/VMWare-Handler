...
type TimeRangeDropdownFilterWidgetConfiguration struct {
	...
	DropdownFilterPlotConfig *DropdownFilterPlotConfiguration `json:"dropdown_filter_plot_config,omitempty"`
	DropdownItem *DropdownItem `json:"dropdown_item,omitempty"`
	...
	TimeRangeFilterInfo *TimeRangeFilterInfo `json:"time_range_filter_info,omitempty"`
}
