...
type ShaPredefinedPluginProfile struct {
	...
	// The Policy group path to apply the changes on Sha Plugin. It can be pre-defined plugin or dynamic created plugin. 
	...
	Config *ShaPredefinedPluginProfileData `json:"config"`
}
