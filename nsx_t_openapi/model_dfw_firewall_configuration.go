...
type DfwFirewallConfiguration struct {
	...
	IdfwEventLogScraperEnabled bool `json:"idfw_event_log_scraper_enabled,omitempty"`
	// If set to true, collection of login/logout events from Loginsight server is enabled. 
	IdfwLoginsightEnabled bool `json:"idfw_loginsight_enabled,omitempty"`
}
