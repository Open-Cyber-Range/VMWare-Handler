...
type AlbWafPolicyPsmGroup struct {
	...
	// Enable or disable this WAF rule group. Default value when not specified in API or module is interpreted by ALB Controller as true. 
	Enable bool `json:"enable,omitempty"`
	// If a rule in this group matches the match_value pattern, this action will be executed. Allowed actions are WAF_ACTION_NO_OP and WAF_ACTION_ALLOW_PARAMETER. Default value when not specified in API or module is interpreted by ALB Controller as WAF_ACTION_ALLOW_PARAMETER. 
	HitAction string `json:"hit_action,omitempty"`
	// This field indicates that this group is used for learning. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	IsLearningGroup bool `json:"is_learning_group,omitempty"`
	// Positive Security Model locations. These are used to partition the application name space. Maximum of 16384 items allowed. 
	Locations []AlbWafPsmLocation `json:"locations,omitempty"`
	...
	// If a rule in this group does not match the match_value pattern, this action will be executed. Allowed actions are WAF_ACTION_NO_OP and WAF_ACTION_BLOCK. Default value when not specified in API or module is interpreted by ALB Controller as WAF_ACTION_NO_OP. 
