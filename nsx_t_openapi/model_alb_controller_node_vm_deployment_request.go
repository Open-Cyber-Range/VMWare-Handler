...
type AlbControllerNodeVmDeploymentRequest struct {
	...
	DeploymentConfig *AlbControllerNodeVmDeploymentConfig `json:"deployment_config"`
	// Specifies the desired \"size\" of the VM 
	FormFactor string `json:"form_factor,omitempty"`
	UserSettings *AlbControllerNodeUserSettings `json:"user_settings,omitempty"`
