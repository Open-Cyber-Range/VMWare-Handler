...
type AlbStringGroup struct {
	...
	Kv []AlbKeyValue `json:"kv,omitempty"`
	// Enable the longest match, default is the shortest match. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	...
	// Type of StringGroup. Enum options - SG_TYPE_STRING, SG_TYPE_KEYVAL. Default value when not specified in API or module is interpreted by ALB Controller as SG_TYPE_STRING. 
