...
type AlbAuthProfile struct {
	...
	Http *AlbAuthProfileHttpClientParams `json:"http,omitempty"`
	Ldap *AlbLdapAuthSettings `json:"ldap,omitempty"`
	...
	Saml *AlbSamlSettings `json:"saml,omitempty"`
	TacacsPlus *AlbTacacsPlusAuthSettings `json:"tacacs_plus,omitempty"`
