...
type AlbApplicationProfile struct {
	...
	// Checksum of application profiles. Internally set by cloud connector. 
	CloudConfigCksum string `json:"cloud_config_cksum,omitempty"`
	// Name of the application profile creator.
	CreatedBy string `json:"created_by,omitempty"`
	DnsServiceProfile *AlbDnsServiceApplicationProfile `json:"dns_service_profile,omitempty"`
	DosRlProfile *AlbDosRateLimitProfile `json:"dos_rl_profile,omitempty"`
	HttpProfile *AlbhttpApplicationProfile `json:"http_profile,omitempty"`
	...
	// Specifies if client IP needs to be preserved for backend connection. Not compatible with Connection Multiplexing. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	PreserveClientIp bool `json:"preserve_client_ip,omitempty"`
	// Specifies if we need to preserve client port while preserving client IP for backend connections. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	PreserveClientPort bool `json:"preserve_client_port,omitempty"`
	// Specifies if destination IP and port needs to be preserved for backend connection. Allowed in Basic(Allowed values- false) edition, Essentials(Allowed values- false) edition, Enterprise edition. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	PreserveDestIpPort bool `json:"preserve_dest_ip_port,omitempty"`
	SipServiceProfile *AlbSipServiceApplicationProfile `json:"sip_service_profile,omitempty"`
	TcpAppProfile *AlbtcpApplicationProfile `json:"tcp_app_profile,omitempty"`
