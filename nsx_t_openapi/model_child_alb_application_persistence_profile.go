...
type ChildAlbApplicationPersistenceProfile struct {
	...
	ALBApplicationPersistenceProfile *AlbApplicationPersistenceProfile `json:"ALBApplicationPersistenceProfile"`
}
