...
type Albl4PolicySet struct {
	...
	// Placeholder for description of property is_internal_policy of obj type L4PolicySet field type str  type boolean. Default value when not specified in API or module is interpreted by ALB Controller as false. 
	IsInternalPolicy bool `json:"is_internal_policy,omitempty"`
	L4ConnectionPolicy *Albl4ConnectionPolicy `json:"l4_connection_policy,omitempty"`
