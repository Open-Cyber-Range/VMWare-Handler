...
type AlbSecurityPolicy struct {
	...
	DnsAttacks *AlbDnsAttacks `json:"dns_attacks,omitempty"`
	// Index of the dns policy to use for the mitigation rules applied to the dns attacks. Default value when not specified in API or module is interpreted by ALB Controller as 0. 
	DnsPolicyIndex int64 `json:"dns_policy_index,omitempty"`
	...
	// Index of the network security policy to use for the mitigation rules applied to the attacks. Default value when not specified in API or module is interpreted by ALB Controller as 0. 
	NetworkSecurityPolicyIndex int64 `json:"network_security_policy_index,omitempty"`
	// Mode of dealing with the attacks - perform detection only, or detect and mitigate the attacks. Enum options - DETECTION, MITIGATION. Default value when not specified in API or module is interpreted by ALB Controller as DETECTION. 
