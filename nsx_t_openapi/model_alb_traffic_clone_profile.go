...
type AlbTrafficCloneProfile struct {
	...
	CloneServers []AlbCloneServer `json:"clone_servers,omitempty"`
	...
	// Specifies if client IP needs to be preserved to clone destination. Default value when not specified in API or module is interpreted by ALB Controller as false. 
