...
// Child wrapper object for TlsConfigProfileBindingMap, used in hierarchical API 
type ChildTlsConfigProfileBindingMap struct {
	...
	RequestParameter *PolicyRequestParameter `json:"request_parameter,omitempty"`
	SessionTimerProfileBindingMap *TlsConfigProfileBindingMap `json:"SessionTimerProfileBindingMap"`
}
