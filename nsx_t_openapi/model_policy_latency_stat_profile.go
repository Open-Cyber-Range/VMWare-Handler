...
type PolicyLatencyStatProfile struct {
	...
	AppliedToGroupPath string `json:"applied_to_group_path,omitempty"`
	// Enable or Disable pnic latency. 
	PnicLatencyEnabled bool `json:"pnic_latency_enabled,omitempty"`
	// Event nth milliseconds packet is sampled. When a value less than 1000 is given, the realized sampling interval will be 1000 milliseconds. 
