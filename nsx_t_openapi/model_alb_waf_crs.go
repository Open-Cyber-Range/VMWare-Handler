...
type AlbWafCrs struct {
	...
	// WAF Rules are sorted in groups based on their characterization. Maximum of 64 items allowed. 
	Groups []AlbWafRuleGroup `json:"groups,omitempty"`
