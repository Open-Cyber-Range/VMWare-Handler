...
type AlbWafProfile struct {
	...
	Config *AlbWafConfig `json:"config"`
	// List of Data Files Used for WAF Rules. Maximum of 64 items allowed. 
	Files []AlbWafDataFile `json:"files,omitempty"`
