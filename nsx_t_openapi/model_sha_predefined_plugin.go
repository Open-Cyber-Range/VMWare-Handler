...
type ShaPredefinedPlugin struct {
	...
	Config *ShaPredefinedPluginProfileData `json:"config,omitempty"`
	// The corresponding plugin will wait for config seconds after reboot. 
	DelayOnReboot int64 `json:"delay_on_reboot,omitempty"`
	// The on-off switch of Sha plugin
	Enabled bool `json:"enabled,omitempty"`
	// Display the pre-req conditions to run the predefined plugin. 
	PreReqConditions []string `json:"pre_req_conditions,omitempty"`
