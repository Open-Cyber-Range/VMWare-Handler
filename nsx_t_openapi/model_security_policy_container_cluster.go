...
type SecurityPolicyContainerCluster struct {
	...
	ContainerClusterPath string `json:"container_cluster_path"`
	// Type of the container cluster where the security policy will be realized
	ContainerClusterType string `json:"container_cluster_type,omitempty"`
}
