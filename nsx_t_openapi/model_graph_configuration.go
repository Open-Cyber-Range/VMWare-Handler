...
type GraphConfiguration struct {
	...
	GraphsColors []string `json:"graphs_colors,omitempty"`
	// List of line chart plotting configuration. This plotting configuration will be applicable for the LINE_GRAPH only.
	LineChartPlotConfigs []LineChartPlotConfiguration `json:"line_chart_plot_configs,omitempty"`
	...
	// x value type.
	XValueType string `json:"x_value_type,omitempty"`
	// y value type.
	YValueType string `json:"y_value_type,omitempty"`
}
