...
type PlatformDeploymentConfig struct {
	...
	DeploymentAction *CloudNativeDeploymentAction `json:"deployment_action,omitempty"`
	KubeconfInfo *KubeconfigInfo `json:"kubeconf_info,omitempty"`
	...
	ServiceConfig *AdvanceServiceConfig `json:"service_config,omitempty"`
}
