...
type TlsCrl struct {
	...
	CrlType string `json:"crl_type,omitempty"`
	Details *X509Crl `json:"details,omitempty"`
	// Certificates revoked by issuer and serial number
	DetailsRevokedByIssuerAndSerialNumber []IssuerSerialNumber `json:"details_revoked_by_issuer_and_serial_number,omitempty"`
	// Certificates revoked by subject and public key hash
	DetailsRevokedBySubjectAndPublicKeyHash []SubjectPublicKeyHash `json:"details_revoked_by_subject_and_public_key_hash,omitempty"`
	// JSON-encoded OneCRL-like object
	OneCrl string `json:"one_crl,omitempty"`
