...
type AntreaClusterInfo struct {
	...
	AgentInfo *AntreaAgentsInfo `json:"agent_info,omitempty"`
	CcpAdapterStatus *AntreaAdapterStatus `json:"ccp_adapter_status,omitempty"`
	ControllerStatus *AntreaControllerStatus `json:"controller_status,omitempty"`
	MpAdapterStatus *AntreaAdapterStatus `json:"mp_adapter_status,omitempty"`
}
