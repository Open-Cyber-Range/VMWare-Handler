...
// Child wrapper object for PolicyTlsConfigProfile, used in hierarchical API 
type ChildPolicyTlsConfigProfile struct {
	...
	PolicyTlsConfigProfile *PolicyTlsConfigProfile `json:"PolicyTlsConfigProfile"`
}
