...
type AlbssoPolicy struct {
	...
	AuthenticationPolicy *AlbAuthenticationPolicy `json:"authentication_policy"`
	AuthorizationPolicy *AlbAuthorizationPolicy `json:"authorization_policy,omitempty"`
	...
	// SSO Policy Type. Enum options - SSO_TYPE_SAML, SSO_TYPE_PINGACCESS, SSO_TYPE_JWT. Default value when not specified in API or module is interpreted by ALB Controller as SSO_TYPE_SAML. 
